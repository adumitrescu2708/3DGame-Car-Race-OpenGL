...
void Lab5::Init()
{
    ...
    {
        Mesh* hexa = object3D::CreateHexa("hexa", glm::vec3(0, 0, 0), 1, 1);
        AddMeshToList(hexa);

        Mesh* plm = object3D::CreateParal("car", glm::vec3(0, 0, 0), 0.5, 0.5, 2);
        AddMeshToList(plm);
...
void Lab5::Test()
{
    ...
    RenderMesh(meshes["hexa"], shaders["VertexNormal"], modelMatrix);
    ...
    modelMatrix = glm::mat4(1);
    modelMatrix = glm::translate(modelMatrix, glm::vec3(2, 0, -0.6));
    modelMatrix = glm::scale(modelMatrix, glm::vec3(0.2, 0.2, 0.2));
    modelMatrix = glm::rotate(modelMatrix, RADIANS(90), glm::vec3(1, 0, 0));
    RenderMesh(meshes["hexa"], shaders["VertexNormal"], modelMatrix);

    modelMatrix = glm::mat4(1);
    modelMatrix = glm::translate(modelMatrix, glm::vec3(0, 0, -0.6));
    modelMatrix = glm::scale(modelMatrix, glm::vec3(0.2, 0.2, 0.2));
    modelMatrix = glm::rotate(modelMatrix, RADIANS(90), glm::vec3(1, 0, 0));
    RenderMesh(meshes["hexa"], shaders["VertexNormal"], modelMatrix);
    ...
    modelMatrix = glm::mat4(1);
    modelMatrix = glm::translate(modelMatrix, glm::vec3(1, 0.2, -0.2));
    RenderMesh(meshes["car"], shaders["VertexNormal"], modelMatrix);


    modelMatrix = glm::mat4(1);
    
    modelMatrix = glm::translate(modelMatrix, glm::vec3(1.6, 0.6, -0.2));
    modelMatrix = glm::scale(modelMatrix, glm::vec3(0.4, 1, 1));
    RenderMesh(meshes["car"], shaders["VertexNormal"], modelMatrix);
}
