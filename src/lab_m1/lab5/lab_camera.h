    ...
    class Camera
    {
     public:
        ...
        void MoveForward(float distance)
        {
            ...
            position += distance * glm::normalize(glm::vec3(forward.x, 0, forward.z));
        }
        ...
        void TranslateRight(float distance)
        {
            ...
            position += distance * glm::normalize(glm::vec3(right.x, 0.0f, right.z));
        }
        ...
        {
            forward = glm::normalize(glm::rotate(glm::mat4(1), angle, glm::vec3(0, 0, 1)) * glm::vec4(forward, 0));
